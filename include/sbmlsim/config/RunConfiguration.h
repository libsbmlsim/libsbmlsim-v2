...
class RunConfiguration {
 public:
  RunConfiguration(double duration, double stepInterval, double observeInterval, std::vector<OutputField> outputFields,
                   double absoluteTolerance = 1e-7, double relativeTolerance = 1e-4);
  RunConfiguration(double start, double duration, double stepInterval, double observeInterval,
                   std::vector<OutputField> outputFields, double absoluteTolerance = 1e-7,
                   double relativeTolerance = 1e-4);
  ~RunConfiguration();
  double getStart() const;
  double getDuration() const;
  double getStepInterval() const;
  double getObserveInterval() const;
